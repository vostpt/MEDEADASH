		...
		dbc.Row(
			...
			dbc.Col(
				...
				dbc.Card(
					...
					dbc.CardBody(
						[
						html.H4(id="var_total_reports",style=card_text_style),
						],
			...
			dbc.Col(
				...
				dbc.Card(
					...
					dbc.CardBody(
						[
						html.H4(id="var_total_firefighters",style=card_exit_text_style),
						],
			...
			dbc.Col(
				...
				dbc.Card(
					...
					dbc.CardBody(
						[
						html.H4(id="var_total_cars",style=card_exit_text_style),
						],
			...
			dbc.Col(
				[
					dbc.Card(
						...
						dbc.CardBody(
							[
							html.H4(id="var_total_planes",style=card_exit_text_style),
							],
...
@callback(
	...
	Output(component_id="var_total_reports", component_property="children"), 
	Output(component_id="var_total_firefighters", component_property="children"),   
	Output(component_id="var_total_cars", component_property="children"),  
	Output(component_id="var_total_planes", component_property="children"),  
	Input(component_id="cards_updater", component_property="n_intervals"),
	)
...
def confirm_update_cards(value):
	...
	df_expanded_timeline = pd.read_csv('https://docs.google.com/spreadsheets/d/e/2PACX-1vTGCDOlWzYjWL_ri9S0CT2PlzHBYIu9rruyWGiqfDXQxqXQHhmL6nyZpyqDpt7KLiZpXqX6o8PUH7Rz/pub?gid=671954915&single=true&output=csv')
	
	df_expanded_timeline['DATE_TIME'] = pd.to_datetime(df_expanded_timeline['DATE_TIME'])
	...
	df_in_line = df_expanded_timeline.groupby(['DATE_TIME','ENTITY'],as_index=False)['TARGET'].nunique()
	df_half = df_in_line.resample('30min', on='DATE_TIME', offset='01s').ENTITY.count().to_frame().reset_index()

	figure_timeline = px.line(df_half,x='DATE_TIME',y='ENTITY',template='plotly_white',labels={"DATE_TIME":"DATE","ENTITY":"Number of Reports"})
...
@callback(
	Output(component_id="fire_timeline", component_property="figure"),
	Input(component_id="graph_updater", component_property="n_intervals"),
)
...
@callback(
	Output(component_id="timeline_table",component_property="children"),
	Input(component_id="table_updater",component_property="n_intervals"),
...
def confirm_update_table(value):
	...
	df_expanded_timeline = df_expanded_timeline.sort_values(by='DATE_TIME',ascending=False)
